...
namespace Monocle
{
    ...
    public class VirtualAxis : VirtualInput
    {
        ...
        {
            public OverlapBehaviors OverlapBehavior;
            public Monocle.VirtualButton Positive;
            public Monocle.VirtualButton Negative;

            private float value;
            private bool turned;

            public VButton(OverlapBehaviors overlapBehavior, Monocle.VirtualButton negative, Monocle.VirtualButton positive)
            {
                OverlapBehavior = overlapBehavior;
                Negative = negative;
                Positive = positive;
