...
namespace Monocle
{
    ...
    public class VirtualJoystick : VirtualInput
    {
        ...
        public class VButton : Node
        {
            ...
            public VButton(OverlapBehaviors overlapBehavior, VirtualButton left, VirtualButton right, VirtualButton up, VirtualButton down)
            {
                OverlapBehavior = overlapBehavior;
                Left = left;
                Right = right;
        ...
        public class VAxis : Node {
            ...
            public VAxis(VirtualAxis _horz, VirtualAxis _vert) {
                Vertical = _vert;
                Horizontal = _horz;
            }
