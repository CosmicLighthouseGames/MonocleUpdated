	...
	public class SpriteData
	{
		...
		public void Add(XmlElement xml, string overridePath = null)
		{
			...
			//Create the Sprite
			{
				...
				{
					Sprite.JustifyOrigin(source.XML.ChildPosition2D("Justify"));
					Sprite.Justify = source.XML.ChildPosition2D("Justify");
				}
				else if (source.XML.HasChild("Origin"))
					Sprite.Origin = source.XML.ChildPosition2D("Origin");
