...
namespace Monocle
{
    public static class Tiler
    {
        ...
        public static int[,] Tile(bool[,] bits, Func<int> tileDecider, Action<int> tileOutput, EdgeBehavior edges)
        {
        ...
        */
        public static int[,] Tile(bool[,] bits, bool[,] mask, Func<int> tileDecider, Action<int> tileOutput, EdgeBehavior edges)
        {
            int boundsX = bits.GetLength(0);
            int boundsY = bits.GetLength(1);
            int[,] tiles = new int[boundsX, boundsY];
        ...
        public static int[,] Tile(bool[,] bits, AutotileData autotileData, Action<int> tileOutput, EdgeBehavior edges)
        {
            return Tile(bits, autotileData.TileHandler, tileOutput, edges);
        }

        public static int[,] Tile(bool[,] bits, bool[,] mask, AutotileData autotileData, Action<int> tileOutput, EdgeBehavior edges)
        {
            return Tile(bits, mask, autotileData.TileHandler, tileOutput, edges);
        }
        ...
        public static uint TileID { get; private set; }
    }
