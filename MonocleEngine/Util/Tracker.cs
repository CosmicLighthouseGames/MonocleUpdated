...
namespace Monocle
{
    public class Tracker
    {
        ...
        public T GetNearestEntity<T>(Vector3 nearestTo) where T : Entity
        {
            ...
            {
                float distSq = Vector3.DistanceSquared(nearestTo, entity.Position);
        ...
        public T GetNearestComponent<T>(Vector3 nearestTo) where T : Component
        {
            ...
            {
                float distSq = Vector3.DistanceSquared(nearestTo, component.Entity.Position);
